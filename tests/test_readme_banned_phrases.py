...
The README had the same drift class for the "Sweep harness (#2 ·
this PR)" header — the sweep harness is the repo's primary shipped
surface, not a PR-in-flight. This file locks the README against
